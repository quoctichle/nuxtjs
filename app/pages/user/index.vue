...
const size = 440
const prizes = [
  { label: '¥20.000\ncash', color: '#ff9900' },      // cam đậm
  { label: '¥10.000\ncash', color: '#ffe066' },      // vàng sáng
  { label: '¥1000\ncash out', color: '#43b02a' },   // xanh lá đậm
  { label: '¥100\nmonthly fee', color: '#b5e61d' }, // xanh lục nhạt
  { label: '¥200\nmonthly fee', color: '#ff9900' }, // cam đậm
  { label: '¥300\nmonthly fee', color: '#43b02a' }, // xanh lá đậm
  { label: '¥500\nmonthly fee', color: '#ffe066' }, // vàng sáng
  { label: '¥600\nmonthly fee', color: '#b5e61d' }, // xanh lục nhạt
]
