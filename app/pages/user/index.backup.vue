        ...
        <div class="spin-center">
          <div class="simple-wheel-outer">
            <div class="wheel-stack">
              ...
              <svg width="440" height="440" viewBox="0 0 440 440" class="simple-wheel" style="position: absolute; left: 20px; top: 20px; transform: rotate(0deg);">
...
const size = 440
const prizes = [
  { label: '20.000¥\ntiền mặt', color: '#ff922b' },
  { label: '10.000¥\ntiền mặt', color: '#ffe066' },
  { label: '¥1000\ncước tháng', color: '#fab005' },
  { label: '¥100\ncước tháng', color: '#e6e600' },
  { label: '¥200\ncước tháng', color: '#51cf66' },
  { label: '¥300\ncước tháng', color: '#228be6' },
  { label: '¥500\ncước tháng', color: '#fa5252' },
  { label: '¥600\ncước tháng', color: '#51cf66' },
]
...
function labelPos(idx) {
  ...
  const x = r + (r - 80) * Math.cos(a)
  const y = r + (r - 80) * Math.sin(a)
  return { x, y }
}
